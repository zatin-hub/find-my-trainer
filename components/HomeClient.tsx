...
export default function HomeClient({
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-5">
      {/* Hero */}
      <div className="relative mb-5 overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-emerald-500/15 via-teal-500/10 to-transparent px-6 py-8">
